#  Project 1: AI Chatbot Interface
A high-end, responsive chat interface built with *React*, *TypeScript*, and *Tailwind CSS*.

### Key Features:
-  **Mobile First:** Fully responsive "floating" input using `shrink-0` and `min-w-0`.
